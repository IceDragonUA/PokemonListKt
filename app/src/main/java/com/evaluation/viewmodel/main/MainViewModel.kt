...
class MainViewModel @ViewModelInject constructor(
    ...
    private var _languageResult: LiveData<List<LanguageTableItem>>? = null
    val languageResult: LiveData<List<LanguageTableItem>>
        get() {
            if (_languageResult == null) {
                _languageResult = LiveDataReactiveStreams.fromPublisher(interaction.loadLanguages())
            }
            return _languageResult ?: throw AssertionError("Set to null by another thread")
        }
